...
// TANISHQ Details DB
let TANISHQ_WALLET_BALANCE = 500000;
const TANISHQ_ADDRESSES = [
    {
        id: "TANISHQ001",
        flatNumber: "302",
        buildingName: "Shivam Apt",
        street: "LIC Colony",
        pincode: "500026",
...
function placeAnOrder(orderItems, discountCoupon, addressId) {
    ...
    if(discountCoupon){
        ...
        if(totalPayablePriceAfterDiscountDeduction < TANISHQ_WALLET_BALANCE){
    
            // cut the ammount from the SUNDEEEP wallet
            TANISHQ_WALLET_BALANCE = TANISHQ_WALLET_BALANCE - totalPayablePriceAfterDiscountDeduction
        }
    }
    ...
    for (const address of TANISHQ_ADDRESSES) {
